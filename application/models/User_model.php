...
class User_model extends CI_Model{
	...
	function get($params = array()){
		$this->db->select('user_id,user_name,user_password,
			user_image,user_full_name,user_email,user_description,user_input_date,user_last_update,user_role_role_id,user_role.role_name');
	...
	#Get role from database / hak akses
	...
	function add($data = array())
	{
		...
		$status = $this->db->fbsql_affected_rows();
